package com.kopetto.sample.oauth;
...
public class OAuth2AdminController {
	...
	@Autowired
	private WebAppUserApprovalHandler userApprovalHandler;
	...
	@RequestMapping("/oauth/clear_tokens")
	@ResponseStatus(HttpStatus.NO_CONTENT)
	 ...
	 */
	public void setUserApprovalHandler(WebAppUserApprovalHandler userApprovalHandler) {
